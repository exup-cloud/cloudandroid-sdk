package com.yjkj.chainup.contract.widget.bubble;
...
import static com.yjkj.chainup.contract.widget.bubble.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.yjkj.chainup.contract.widget.bubble.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.yjkj.chainup.contract.widget.bubble.BubbleSeekBar.TextPosition.SIDES;
import static com.yjkj.chainup.contract.widget.bubble.BubbleUtils.dp2px;
import static com.yjkj.chainup.contract.widget.bubble.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isShowThumbText = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_show_thumb_text, false);
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_bubble_text_size, sp2px(14));
