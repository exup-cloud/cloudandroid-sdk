...
import static com.bmtc.sdk.contract.view.bubble.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.bmtc.sdk.contract.view.bubble.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.bmtc.sdk.contract.view.bubble.BubbleSeekBar.TextPosition.SIDES;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.BubbleSeekBar_bsb_track_drawable);
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.colorAccent));

        mSecondTrackDrawable = a.getDrawable(R.styleable.BubbleSeekBar_bsb_second_track_drawable);

        mThumbColor = a.getColor(R.styleable.BubbleSeekBar_bsb_thumb_color, mSecondTrackColor);
        mThumbDrawable = a.getDrawable(R.styleable.BubbleSeekBar_bsb_thumb_drawable);
        ...
        mSectionTextColor = a.getColor(R.styleable.BubbleSeekBar_bsb_section_text_color, ContextCompat.getColor(context, R.color.sl_grayText));
            ...
            for (int i = 0; i <= mSectionCount; i++) {
                ...
                if (isRtl) {
                    if (x_ <= junction) {
                        ...
                        canvas.drawBitmap(mSecondCircle, x_ - dp2px(20)/2, yTop - mSecondCircle.getHeight()/2, mPaint);
                    }
                } else {
                    if (x_ <= junction) {
                        canvas.drawBitmap(mSecondCircle, x_ - dp2px(20)/2, yTop- mSecondCircle.getHeight()/2, mPaint);
                ...
                if (isShowTextBelowSectionMark) {
                    mPaint.setColor(mContext.getResources().getColor(R.color.sl_grayText));
