...
package com.bmtc.sdk.contract.view.scrollview;
...
//                //获取最后一个可见view的位置
//                int firstVisiblePosition = linearManager.findLastVisibleItemPosition();
//                //获取第一个可见view的位置
//                int lastVisiblePosition = linearManager.findFirstVisibleItemPosition();
