 ...
 * desc：通用提示框组件
 */
public class PromptWindowWide extends PopupWindow implements View.OnClickListener {
    ...
    public PromptWindowWide(Context context) {
        ...
        View rootView = inflater.inflate(R.layout.sl_dialog_prompt_wide, null);
