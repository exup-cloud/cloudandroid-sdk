 ...
 */
package com.follow.order.net.log;
...
//        try {
//            CrashReport.putUserData(ApplicationUtils.getApplicationContext(), "url", responseUrl);
////            CrashReport.putUserData(ApplicationUtils.getApplicationContext(), "response", bodyString);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
