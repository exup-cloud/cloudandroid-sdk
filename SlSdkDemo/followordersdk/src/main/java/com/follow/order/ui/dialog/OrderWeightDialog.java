...
public class OrderWeightDialog extends Dialog implements View.OnClickListener {

    private Context context;
    private TextView tv_content, tv_know;

    public OrderWeightDialog(Context context) {
        ...
        setContentView(R.layout.dialog_order_weight);
