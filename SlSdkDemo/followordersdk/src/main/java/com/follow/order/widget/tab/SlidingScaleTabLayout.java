package com.follow.order.widget.tab;
...
import com.follow.order.widget.tab.transformer.IViewPagerTransformer;
import com.follow.order.widget.tab.transformer.TabScaleTransformer;
import com.follow.order.widget.tab.utils.UnreadMsgUtils;
import com.follow.order.widget.tab.widget.MsgView;
...
public class SlidingScaleTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void initTransformer() {
        ...
        if (mTextUnSelectSize != mTextSelectSize) {
            defaultTransformer = new TabScaleTransformer(this, mViewPager.getAdapter(), mTextSelectSize, mTextUnSelectSize, fixPosition);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.fo_layout_flyco_tab, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.fo_layout_flyco_tab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != -1) {
                    if (mListener != null) {
                        if (mListener.onTabSelectBefore(position)) {
                            return;
                        }
                    }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                if (fixPosition == i) {
                    tv_tab_title.setTextColor(mFixTextColor);
                } else {
                ...
                // 被选中设置为粗体
                else if (mTextBold == TEXT_BOLD_WHEN_SELECT && (i == mCurrentTab || i == fixPosition)) {
                    tv_tab_title.getPaint().setFakeBoldText(true);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                if (fixPosition == i) {
                    tab_title.setTextColor(mFixTextColor);
                } else {
    ...
    public void setTextFixColor(int fixTextColor) {
        this.mFixTextColor = fixTextColor;
        updateTabStyles();
    }
