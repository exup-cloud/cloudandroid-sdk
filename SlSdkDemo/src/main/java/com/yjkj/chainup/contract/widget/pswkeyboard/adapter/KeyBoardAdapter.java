package com.yjkj.chainup.contract.widget.pswkeyboard.adapter;
...
public class KeyBoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.sl_item_grid_virtual_keyboard, null);
        ...
        if (position == 9) {
            ...
            viewHolder.btnKey.setBackgroundResource(R.drawable.sl_keyboard_delete_img);
