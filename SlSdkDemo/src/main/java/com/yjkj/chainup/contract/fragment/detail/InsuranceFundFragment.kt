...
import com.yjkj.chainup.contract.adapter.InsuranceFundAdapter
 ...
 * 保险基金
 */
class InsuranceFundFragment : NBaseFragment() {
    ...
    private fun initHeaderView() {
        ...
        headerView.findViewById<TextView>(R.id.tv_header_right).onLineText("sl_str_balance_insurance_fund")
    }
